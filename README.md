...
| 2025.12 - **Present** | **신한투자증권 프로디지털아카데미 7기** | 백엔드 개발 및 금융 도메인 학습 |
...
| 기간 | 프로젝트명 | 성격 | 핵심 가치 |
|:--- |:--- |:--- |:--- |
| 2025.10 - **Present** | **추억 지도 공유 모바일 앱** | 팀 프로젝트 | 위치 데이터 정합성 및 안정적 API 설계 |
| 2025.10 - 2025.12 | **PAIS, 개인 맞춤형 AI 비서** | 팀 프로젝트 | 사용자 맞춤형 데이터 처리 및 서비스 안정성 |
| 2025.03 - 2025.06 | **문서 보안등급 자동분류 AI** | 팀 프로젝트 | 보안 데이터 분류 모델링 및 안정적 파이프라인 |
